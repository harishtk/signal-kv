...
public class KeyValueDataSet implements KeyValueReader {
    ...
    public @NonNull Map<String, Object> getValues() { return values; }

    public Class getType(@NonNull String key) { return types.get(key); }
    ...
    @Override
    public boolean containsKey(@NonNull String key) { return values.containsKey(key); }
